...
const CORE=['./','./index.html','./manifest.webmanifest','./runtime-config.js','./src/app.js','./src/cloud.js','./src/db.js','./src/printer.js','./src/layout.js','./src/academy-content.js','./src/academy.js','./src/i18n.js','./src/ui.js','./src/telemetry.js','./src/styles.css','./assets/icon.svg'];
