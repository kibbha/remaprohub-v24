...
Deno.serve(async(req)=>{
  ...
  try{
    ...
    if(action==="create_order"){
      ...
      await db.from("direct_order_events").insert({direct_order_id:created.id,event_type:"submitted",details:{serviceType:mode,itemCount:rows.length,paymentMethod,requestedFor}});
