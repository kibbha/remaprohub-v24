...
export const BIOMETRIC_SECURITY_DISABLED=true;
...
export function securitySettings(){
  try{
    ...
    return {...DEFAULTS,...raw,lockMinutes,biometricEnabled:false,lockOnBackground:raw.lockOnBackground!==false};
...
export async function biometricAvailability(){
  return{isAvailable:false,deviceIsSecure:false,strongBiometryIsAvailable:false,disabledForSecurity:true};
}
export async function verifyBiometric(){
  throw new Error('BIOMETRIC_DISABLED_SECURITY_ADVISORY');
}
