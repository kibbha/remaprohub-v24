...
export function bindFloorPlanEditor(root,{getPlans,setPlans,getPlanId,setPlanId,getElementId,setElementId,onDirty,onSave,onPublish,onActivate,onRestore,onNew,onDuplicate,onRender}={}){
  if(!root)return;
  ...
  root.querySelector('#floorPlanActivate')?.addEventListener('click',()=>onActivate?.());
