...
CH:{
 ...
 payslip:[...payCore,f('employeeAhvNumber','employee'),f('employerAhvNumber','employer'),f('ahvSubjectSalary','deductions','number',false,{min:0,step:'0.01'}),f('acSubjectSalary','deductions','number',false,{min:0,step:'0.01'}),f('lppInsuredSalary','deductions','number',false,{min:0,step:'0.01'}),f('accidentSubjectSalary','deductions','number',false,{min:0,step:'0.01'}),f('avsAiApg','deductions','number',false,{min:0,step:'0.01'}),f('unemploymentInsurance','deductions','number',false,{min:0,step:'0.01'}),f('pensionEmployee','deductions','number',false,{min:0,step:'0.01'}),f('accidentEmployee','deductions','number',false,{min:0,step:'0.01'}),f('withholdingTax','deductions','number',false,{min:0,step:'0.01'}),f('withholdingCanton','deductions'),f('employerContributions','employerCharges','number',false,{min:0,step:'0.01'})],
