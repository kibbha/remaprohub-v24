export const LEGAL_REVIEW_DATE='2026-09-19';
...
const packs={
CH:{
 name:'Suisse',source:'CO art. 323b et 330b · SECO / Fedlex',note:'Les cotisations et retenues varient notamment selon caisse, assureur, caisse de pension, canton, statut fiscal et CCT.',
 payslip:[...payCore,f('employeeAhvNumber','employee'),f('employerAhvNumber','employer'),f('avsAiApg','deductions','number',false,{min:0,step:'0.01'}),f('unemploymentInsurance','deductions','number',false,{min:0,step:'0.01'}),f('pensionEmployee','deductions','number',false,{min:0,step:'0.01'}),f('accidentEmployee','deductions','number',false,{min:0,step:'0.01'}),f('withholdingTax','deductions','number',false,{min:0,step:'0.01'}),f('withholdingCanton','deductions'),f('employerContributions','employerCharges','number',false,{min:0,step:'0.01'})],
