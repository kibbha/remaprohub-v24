...
## Compilation Android
Le workflow GitHub Actions V25.5 crée un projet Android propre, installe Capacitor, applique l’activité immersive, valide le manifeste XML puis lance Gradle. La compilation complète dépend de l’exécution sur le runner GitHub et n’a pas été simulée localement dans cet environnement.
