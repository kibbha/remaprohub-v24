...
The current bundle covers catalog, layout, floor plan, tables, printer/KDS routes and terminal capabilities. The older direct publication controls remain available; their edits supersede a published bundle. This transitional behavior is displayed in Hub so the manager can prepare a fresh bundle after a direct change.
