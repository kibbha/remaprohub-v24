...
const dedicatedForms=new Set(['settingsForm','securitySettingsForm','securityLoginForm','securitySignupForm','developerLoginForm','developerAccessForm','memberAccessForm','billingPurchaseForm','cloudForm','cloudLoginForm','aiForm','visionStockForm','invoiceReviewForm','restaurantForm','managerForm','staffAccessForm']);
