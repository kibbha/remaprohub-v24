...
const dedicatedForms=new Set(['settingsForm','subscriptionForm','cloudForm','aiForm','visionStockForm','invoiceReviewForm','restaurantForm','managerForm','staffAccessForm']);
