...
const dedicatedForms=new Set(['settingsForm','securitySettingsForm','securityLoginForm','securitySignupForm','developerLoginForm','developerAccessForm','memberAccessForm','billingPurchaseForm','cloudForm','cloudLoginForm','aiForm','visionStockForm','invoiceReviewForm','deliveryScanReviewForm','restaurantForm','managerForm','staffAccessForm','directChannelForm','posTableAddForm','posOperatorAddForm','posPrinterAddForm','posTerminalAddForm','posProviderAddForm','supportTicketForm']);
