...
const dedicatedForms=new Set(['settingsForm','subscriptionForm','cloudForm','cloudLoginForm','aiForm','visionStockForm','invoiceReviewForm','restaurantForm','managerForm','staffAccessForm']);
