...
for(const token of ['support_tickets','support_messages','ai_agent_runs','platform_inbox','OPENAI_API_KEY'])if(!fn.includes(token))throw new Error('Missing support backend token: '+token);
