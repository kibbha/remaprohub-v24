...
for(const token of ['function trainingView','TRAINING_REAL_ACTION_BLOCKED','if(state.trainingMode)return;','academy-help-context','academyFunction','academy-scope','academy-copy-context','posOrgAdmin','canManageVisibility:posOrgAdmin()'])assert.ok((app+cloud).includes(token),token);
...
assert.ok(sw.includes('remapro-pos-shell-v0270-academy-final'),'offline cache refreshed');
