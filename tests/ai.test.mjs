...
assert.match(edge,/store:false/);assert.match(edge,/context\.manager\.readyActions/);assert.match(edge,/context\.manager\.supplierOpportunities/);assert.match(edge,/context\.manager\.setupSteps/);assert.match(edge,/daily management report/);
