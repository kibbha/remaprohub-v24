...
assert.equal(pkg.dependencies['@capgo/capacitor-native-biometric'],undefined);
...
assert.doesNotMatch(securitySource,/verifyIdentity/);assert.match(securitySource,/BIOMETRIC_DISABLED_SECURITY_ADVISORY/);
