...
for(const name of ['layout-dashboard','clipboard-check','chart-bar','file-description','layout-grid','package','truck-delivery','settings','users','help','sparkles'])assert.ok(ids.has(name),name);
