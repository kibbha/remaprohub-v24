...
for(const module of ['app.js','i18n.js','store.js','ai.js','cloud.js'])assert.equal(readFileSync(`app/src/${module}`,'utf8'),readFileSync(`src/${module}`,'utf8'));
const hash=createHash('sha256');
for(const asset of ['index.html','styles.css','icons.svg','manifest.json','icon.svg','assets-remaprohub-logo.png','src/app.js','src/i18n.js','src/store.js','src/ai.js','src/cloud.js']){
  hash.update(asset);
