...
for(const token of ['data-layout-page-delete','data-layout-page-name','data-layout-category-name','data-layout-modifier-edit','data-layout-menu-edit','data-layout-option-edit','data-layout-choice-edit','name="productIds"'])assert.ok(layoutSource.includes(token),'enhanced structured Hub editor includes '+token);
