...
for(const name of ['app.js','restored.js','i18n.js','store.js','ai.js','cloud.js','legal.js','billing.js','security.js','intelligence.js','pos.js','pos-layout.js','delivery-ai.js','academy-content.js','academy.js','telemetry.js','workspace-storage.js'])await copyFile(resolve(root,'src',name),resolve(output,name));
const assets=['index.html','bootstrap.js','runtime-config.js','privacy-policy.html','account-deletion.html','order.html','order.css','order.js','styles.css','icons.svg','manifest.json','icon.svg','assets-remaprohub-logo.png','src/app.js','src/restored.js','src/i18n.js','src/store.js','src/ai.js','src/cloud.js','src/legal.js','src/billing.js','src/security.js','src/intelligence.js','src/pos.js','src/pos-layout.js','src/delivery-ai.js','src/academy-content.js','src/academy.js','src/telemetry.js'];
