...
for(const name of ['app.js','restored.js','i18n.js','store.js','ai.js','cloud.js','legal.js','billing.js','security.js','intelligence.js','pos.js','pos-layout.js','delivery-ai.js','academy-content.js','academy.js'])await copyFile(resolve(root,'src',name),resolve(output,name));
