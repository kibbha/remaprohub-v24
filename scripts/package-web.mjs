...
for(const name of ['app.js','restored.js','i18n.js','store.js','ai.js','cloud.js','legal.js','billing.js','security.js'])await copyFile(resolve(root,'src',name),resolve(output,name));
const assets=['index.html','bootstrap.js','runtime-config.js','privacy-policy.html','account-deletion.html','styles.css','icons.svg','manifest.json','icon.svg','assets-remaprohub-logo.png','src/app.js','src/restored.js','src/i18n.js','src/store.js','src/ai.js','src/cloud.js','src/legal.js','src/billing.js','src/security.js'];
