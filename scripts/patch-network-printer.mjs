...
await copyFile(resolve(root,'android-native/TapToPayPlugin.java'),resolve(javaDir,'TapToPayPlugin.java'));
...
if(!activity.includes('registerPlugin(TapToPayPlugin.class);'))throw new Error('Unable to register TapToPayPlugin');
...
console.log('ReMaPro network ESC/POS, Tap to Pay bridge and immersive activity installed');
